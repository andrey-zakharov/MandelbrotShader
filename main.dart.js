...
["fpsstats", "package:stats/stats.dart", , M, {
  ...
  Stats: {
    ...
    _onContainerMouseDown$1: [function(e) {
      ...
      t1 = this._mode + 1;
      this.set$mode(0, t1);
      this.set$mode(0, C.JSInt_methods.$mod(t1, 2));
    }, "call$1", "get$_onContainerMouseDown", 2, 0, 25],
...
["mandel", "main.dart", , Z, {
  ...
  main: [function() {
    ...
    t2 = $.Field_planeSize;
    t3 = -t2;
    t3 = new Z.Field(t1, null, null, 2, new Float32Array(H._ensureNativeList([t3, t3, t2, t2, t3, t2, t3, t3, t2, t2, t2, t3])), P.Rectangle$(-2, -1.5, 3, 3, null), null, null);
    t3.program = t3.initShaders$0();
    t3.initBuffers$0();
    t3.initUniforms$0();
    $.field = t3;
    t3 = C.EventStreamProvider_resize.forTarget$1(window);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(Z.onResize$closure()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    $.animManager = new B.TweenManager(H.setRuntimeTypeInfo([], [B.BaseTween]), false);
    $.Tween__combinedAttrsLimit = 4;
    t3 = Z.Controls$($.canvas);
    $.controls = t3;
    t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl($.canvas, t3.onDrag._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(Z.onDrag$closure()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = document.body;
    t3.children;
    t3.appendChild($.get$stats().container);
    J.set$position$x($.get$stats().container.style, "absolute");
    J.set$bottom$x($.get$stats().container.style, "0px");
    C.Window_methods.get$animationFrame(window).then$1(Z.draw$closure());
  }, "call$0", "main$closure", 0, 0, 9],
  status: function(message) {
    J.set$innerHtml$x(document.querySelector("#status"), "<p>" + H.S(message) + "</p>");
  },
  initGL: function() {
    var t1, t2;
    t1 = W._ElementFactoryProvider_createElement_tag("canvas", null);
    $.canvas = t1;
    document.body.appendChild(t1);
    t1 = $.canvas;
    t2 = document.body;
    t2.toString;
    J.set$width$x(t1, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.clientWidth)));
    J.set$height$x($.canvas, window.innerHeight);
    t2 = J.getContext$1$x($.canvas, "webgl");
    $.gl = t2;
    if (t2 == null) {
      ...
      t1 = t2;
    if (t1 == null) {
      Z.status("\u041f\u0440\u043e\u0441\u0442\u0438\u0442\u0435, \u0432\u0430\u0448 \u0431\u0440\u0430\u0443\u0437\u0435\u0440 \u043d\u0435 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u0438\u0432\u0430\u0435\u0442 WebGl");
      return;
    }
    J.viewport$4$x(t1, 0, 0, J.get$width$x($.canvas), J.get$height$x($.canvas));
    Z.status("");
    return $.gl;
  },
  onResize: [function(e) {
    ...
    C.Window_methods.get$animationFrame(window).then$1(Z.draw$closure());
  }, "call$1", "onResize$closure", 2, 0, 10],
  draw: [function(delta) {
    var t1, t2, time, t3, t4;
    $.get$stats()._timer.start$0(0);
    t1 = J.$sub$n(delta, $.lastUpdate);
    if (typeof t1 !== "number")
      return t1.$div();
    $.lastUpdate = delta;
    $.animManager.update$1(delta);
    t1 = $.field;
    t2 = t1.gl;
    J.clearColor$4$x(t2, 0, 0, 0, 1);
    t2.clear(16384);
    t2.drawArrays(4, 0, C.JSInt_methods.$tdiv(t1.vertices.length, t1._dims));
    if ($.animManager._objects.length > 0) {
      t1 = window;
      C.Window_methods._ensureRequestAnimationFrame$0(t1);
      C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(Z.draw$closure()));
    }
    t1 = $.get$stats();
    t2 = t1._timer;
    time = J.$tdiv$n(J.$mul$ns(t2.get$elapsedTicks(), 1000), $.Stopwatch__frequency);
    t3 = J.$tdiv$n(J.$mul$ns(t2.get$elapsedTicks(), 1000), $.Stopwatch__frequency);
    t1._ms = t3;
    t1._msMin = P.min(t1._msMin, t3);
    t1._msMax = P.max(t1._msMax, t1._ms);
    t1.msText.textContent = H.S(t1._ms) + " MS (" + H.S(t1._msMin) + " - " + H.S(t1._msMax) + ")";
    t3 = t1.msGraph;
    t4 = t1._ms;
    if (typeof t4 !== "number")
      return t4.$div();
    t1.updateGraph$2(t3, P.min(30, 30 - t4 / 200 * 30));
    ++t1._frames;
    if (J.$gt$n(time, 1000)) {
      t3 = t1._frames;
      t4 = t1._ms;
      if (typeof t4 !== "number")
        return H.iae(t4);
      t4 = C.JSInt_methods.toInt$0(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3 * 1000 / t4)));
      t1._fps = t4;
      t1._fpsMin = P.min(t1._fpsMin, t4);
      t1._fpsMax = P.max(t1._fpsMax, t1._fps);
      t1.fpsText.textContent = "" + t1._fps + " FPS (" + H.S(t1._fpsMin) + " - " + H.S(t1._fpsMax) + ")";
      t1.updateGraph$2(t1.fpsGraph, P.min(30, 30 - t1._fps / 100 * 30));
      t2.reset$0(0);
      t1._frames = 0;
    }
  }, "call$1", "draw$closure", 2, 0, 11],
  onDrag: [function(e) {
    var t1, relative, t2, t3, t4;
    t1 = J.getInterceptor$x(e);
    relative = J.$sub$n(t1.get$detail(e).get$current(), t1.get$detail(e).get$previous());
    relative = $.field.scaleToRange$1(relative);
    t1 = $.field;
    t2 = J.$sub$n(t1.range.left, relative.x);
    t3 = J.$sub$n($.field.range.top, relative.y);
    t4 = t1.range;
    t1.range = P.Rectangle$(t2, t3, t4.width, t4.height, null);
    t1.loadRangeBuffer$0();
    C.Window_methods.get$animationFrame(window).then$1(Z.draw$closure());
  }, "call$1", "onDrag$closure", 2, 0, 12],
  Field: {
    "^": "Object;gl,program,_fractalTexture,_dims,vertices,range,vertexBuffer,rangeBuffer",
    initShaders$0: function() {
      var t1, vs, fs, p;
      t1 = this.gl;
      vs = J.createShader$1$x(t1, 35633);
      t1.shaderSource(vs, document.querySelector("#shader-vx").textContent);
      t1.compileShader(vs);
      if (t1.getShaderParameter(vs, 35713) !== true) {
        P.print(t1.getShaderInfoLog(vs));
        Z.status(t1.getShaderInfoLog(vs));
        throw H.wrapException(P.Exception_Exception(t1.getShaderInfoLog(vs)));
      }
      fs = t1.createShader(35632);
      t1.shaderSource(fs, document.querySelector("#shader-fx").textContent);
      t1.compileShader(fs);
      if (t1.getShaderParameter(fs, 35713) !== true) {
        P.print(t1.getShaderInfoLog(fs));
        Z.status(t1.getShaderInfoLog(fs));
        throw H.wrapException(P.Exception_Exception(t1.getShaderInfoLog(fs)));
      }
      p = t1.createProgram();
      t1.attachShader(p, vs);
      t1.attachShader(p, fs);
      t1.linkProgram(p);
      t1.useProgram(p);
      if (t1.getProgramParameter(p, 35714) !== true) {
        P.print(t1.getProgramInfoLog(p));
        Z.status(t1.getShaderInfoLog(p));
        throw H.wrapException(P.Exception_Exception(t1.getShaderInfoLog(p)));
      }
      return p;
    },
    initUniforms$0: function() {
      var t1, uColor, viewport, kmax, u_range, t2, t3, t4;
      t1 = this.gl;
      uColor = J.getUniformLocation$2$x(t1, this.program, "u_color");
      viewport = t1.getUniformLocation(this.program, "u_viewport");
      kmax = t1.getUniformLocation(this.program, "u_kmax");
      u_range = t1.getUniformLocation(this.program, "u_range");
      t1.uniform2f(viewport, t1.drawingBufferWidth, t1.drawingBufferHeight);
      t2 = this.range;
      t3 = J.$add$ns(t2.top, t2.height);
      t4 = this.range;
      t1.uniform4f(u_range, t2.left, t3, J.$add$ns(t4.left, t4.width), this.range.top);
      t1.uniform2fv(uColor, new Float32Array(H._ensureNativeList([0.5, 0.9, 0.9, 1])));
      t1.uniform1i(kmax, 20);
    },
    initBuffers$0: function() {
      var t1, aPosition, aRange, t2;
      t1 = this.gl;
      aPosition = J.getAttribLocation$2$x(t1, this.program, "a_position");
      aRange = t1.getAttribLocation(this.program, "a_range");
      t2 = t1.createBuffer();
      this.vertexBuffer = t2;
      t1.bindBuffer(34962, t2);
      t1.bufferData(34962, this.vertices, 35044);
      t1.enableVertexAttribArray(aPosition);
      t2 = this._dims;
      t1.vertexAttribPointer(aPosition, t2, 5126, false, 0, 0);
      this.rangeBuffer = t1.createBuffer();
      this.loadRangeBuffer$0();
      t1.bindBuffer(34962, this.rangeBuffer);
      t1.enableVertexAttribArray(aRange);
      t1.vertexAttribPointer(aRange, t2, 5126, false, 0, 0);
    },
    loadRangeBuffer$0: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11;
      t1 = this.gl;
      J.bindBuffer$2$x(t1, 34962, this.rangeBuffer);
      t2 = this.range;
      t3 = J.$add$ns(t2.top, t2.height);
      t4 = this.range;
      t4 = J.$add$ns(t4.left, t4.width);
      t5 = this.range;
      t6 = t5.top;
      t7 = t5.left;
      t5 = J.$add$ns(t6, t5.height);
      t8 = this.range;
      t8 = J.$add$ns(t8.left, t8.width);
      t9 = this.range;
      t10 = J.$add$ns(t9.left, t9.width);
      t11 = this.range;
      t1.bufferData(34962, new Float32Array(H._ensureNativeList([t2.left, t3, t4, t6, t7, t6, t7, t5, t8, t9.top, t10, J.$add$ns(t11.top, t11.height)])), 35044);
      t1.bindBuffer(34962, null);
    },
    scaleToRange$1: function(drag) {
      var t1, t2, t3, t4, t5;
      t1 = J.get$x$x(drag);
      t2 = this.range.width;
      if (typeof t1 !== "number")
      ...
      if (typeof t2 !== "number")
        return H.iae(t2);
      t3 = J.get$clientWidth$x($.canvas);
      t4 = drag.y;
      t5 = this.range.height;
      if (typeof t4 !== "number")
        return t4.$mul();
      if (typeof t5 !== "number")
        return H.iae(t5);
      return H.setRuntimeTypeInfo(new P.Point(t1 * t2 / t3, t4 * t5 / J.get$clientHeight$x($.canvas)), [null]);
    },
    static: {"^": "Field_planeSize,Field_TWEEN_DRAG,Field_TWEEN_ZOOM"}
  },
  Controls: {
    "^": "Object;minSelection,mouseSt,_el,onDrag",
    onMouseDown$1: [function(_, e) {
      ...
      t2 = t2.get$x(t2);
      t1 = t1.get$client(e);
      this.mouseSt = H.setRuntimeTypeInfo(new P.Point(t2, t1.get$y(t1)), [null]);
    }, "call$1", "get$onMouseDown", 2, 0, 28],
    onMouseMove$1: [function(_, e) {
      var t1, t2;
      t1 = this.mouseSt;
      if (t1 != null && t1.squaredDistanceTo$1(J.get$client$x(e)) >= this.minSelection) {
        t1 = J.getInterceptor$x(e);
        J.dispatchEvent$1$x(this._el, W.CustomEvent_CustomEvent("drag", true, true, new Z.DragData(this.mouseSt, t1.get$client(e))));
        this.mouseSt = t1.get$client(e);
      }
      t1 = J.getInterceptor$x(e);
      t2 = $.field.range.toString$0(0) + " - " + t1.get$client(e).toString$0(0) + "  /  ";
      t1 = $.field.scaleToRange$1(t1.get$client(e));
      Z.status(t2 + ("Point(" + H.S(t1.x) + ", " + H.S(t1.y) + ")"));
    }, "call$1", "get$onMouseMove", 2, 0, 28],
    onMouseUp$1: [function(_, e) {
      if (this.mouseSt != null)
        this.mouseSt = null;
    }, "call$1", "get$onMouseUp", 2, 0, 28],
    Controls$1: function(_el) {
      var t1, t2;
      t1 = this._el;
      t2 = J.getInterceptor$x(t1);
      t2.get$onMouseDown(t1).listen$1(this.get$onMouseDown(this));
      t2.get$onMouseMove(t1).listen$1(this.get$onMouseMove(this));
      t2.get$onMouseUp(t1).listen$1(this.get$onMouseUp(this));
      t1 = t2.get$onMouseWheel(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Z.Controls_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {Controls$: function(_el) {
        var t1 = new Z.Controls(1, null, _el, H.setRuntimeTypeInfo(new W.EventStreamProvider("drag"), [null]));
        t1.Controls$1(_el);
        return t1;
      }}
  },
  Controls_closure: {
    "^": "Closure:29;",
    call$1: function(e) {
      P.print(e.get$wheelDeltaY());
      e.get$wheelDeltaY().$lt(0, 0);
      e.get$wheelDeltaY().$gt(0, 0);
    }
  },
  DragData: {
...
Isolate.$lazy($, "stats", "stats", "get$stats", function() {
  H.Primitives_initTicker();
  $.Stopwatch__frequency = $.Primitives_timerFrequency;
  var t1 = new M.Stats(new P.Stopwatch(null, null), 0, 1000, 0, 0, 1000, 0, 0, 0, null, null, null, null, null, null, null);
  t1._createUi$0();
  return t1;
});
...
{func: "dynamic__CustomEvent", args: [W.CustomEvent]},
